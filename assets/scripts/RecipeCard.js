...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		articleElement.innerHTML += `<p class="organization">${data.organization}</p>`;
		articleElement.innerHTML += `<div class="rating"><img src="./assets/images/icons/${data.rating}-star.svg" alt="${data.rating} stars">`;
		articleElement.innerHTML += `<span>(${data.numRatings})</span></div>`;
		articleElement.innerHTML += `<time>${data.lengthTime}</time>`;
		articleElement.innerHTML += `<p class="ingredients">${data.ingredients}</p>`;
	}
}
